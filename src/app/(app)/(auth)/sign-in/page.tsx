...
export default function SignIn() {
    return (
        <div className="min-h-screen flex flex-col pt-40 items-center bg-black">
            ...
            >
                <h1
                    className={`text-5xl font-bold text-foreground ${bricolage_grotesque} font-extrabold`}
                >
                    Welcome Back to EchoSpace
                </h1>

                <p className="text-white font-inter leading-relaxed text-xs">
                    Join the conversation where every voice shapes a better future.
                </p>
                ...
                <div className="pt-6 flex flex-col items-center ">
                    <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                        <button
                            ...
                            type="button"
                            className="py-3 px-10 w-[320px] flex justify-center items-center 
